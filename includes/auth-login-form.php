...
<div class="auth-modal-card auth-card">
    ...
    <form method="post" action="" class="auth-form">
        ...
        <div class="auth-field">
            <input type="text" name="identifier" placeholder="Tên đăng nhập / SĐT / Email" required value="<?php echo $loginIdentifier; ?>" autocomplete="username" id="auth-login-identifier">
        </div>
